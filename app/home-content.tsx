  ...
  return <>
    ...
    <main className="portfolio-layout">
      ...
      <div className="themes-column" id="expertise">
        ...
        <section className="home-testimonial"><div className="home-testimonial-heading"><p className="eyebrow">{t.reviewLabel}</p><span aria-label="5 sur 5">★★★★★</span></div><h2>{t.reviewTitle}</h2><blockquote>“{t.reviewQuote}”</blockquote><div className="home-testimonial-credit"><div><strong>Justin Theytaz</strong><a href="https://2ds.ch/" target="_blank" rel="noreferrer">2DS ↗</a></div><div><Link href="/work/bowling-pin-detection">{t.reviewProject} ↗</Link><span>{t.reviewSource}</span></div></div></section>
